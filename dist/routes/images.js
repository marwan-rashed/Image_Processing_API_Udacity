...
var files_1 = __importDefault(require("../services/files"));
var router = express_1.default.Router();
router.get('/', validation_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, width, height, images, exist, thumb;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                thumb = _b.sent();
                if (thumb) {
                    return [2 /*return*/, res.status(200).sendFile(thumb)];
                }
                else {
